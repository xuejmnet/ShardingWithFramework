...
public abstract class AppShardingDbContext<TDbContext, TDbContextLocator>
    : AppDbContext<TDbContext, TDbContextLocator>, IShardingDbContext, ISupportShardingReadWrite
    where TDbContext : DbContext
    where TDbContextLocator : class, IDbContextLocator
{
    ...
    public override async Task AddRangeAsync(IEnumerable<object> entities,
        CancellationToken cancellationToken = new CancellationToken())
    {
        if (isExecutor)
        {
